...
public class ToolStore extends NormalLoc {
    ...
    public void menu(){
        System.out.println("1-Zırhları listele");
        ...
        switch (input) {
            ...
            for (Armor armor : armors) {
                System.out.println((counter++)+" "+armor.getarmorName()+": Defans -> "+armor.getarmorDefence()+" Para -> "+armor.getCost());
            }
                counter=0;
                break;
            case 2:
                for (Weapon weapon : weapons) {
                    System.out.println((counter++)+" "+weapon.getWeaponName()+": Hasar -> "+weapon.getWeaponDamage()+" Para -> "+weapon.getCost());
                }
                counter=0;
                break;
            default:
    ...
    public void buy(){
        ...
        switch(input){
            ...
            if(armors.get(id).getCost() <= this.getPlayer().getCoin()){
                ...
                System.out.println(armors.get(id).getarmorName()+" aldınız."+"Kalan Para:"+this.getPlayer().getCoin());
            ...
            if(weapons.get(id).getCost() <= this.getPlayer().getCoin()){
                ...
                System.out.println(weapons.get(id).getWeaponName()+" aldınız."+"Kalan Para:"+this.getPlayer().getCoin());
